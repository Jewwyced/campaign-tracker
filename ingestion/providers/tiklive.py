"""
ingestion/providers/tiklive.py — TikLiveAPI provider implementation.

MOVED (provider-boundary refactor) from the old flat
ingestion/tiklive_provider.py — content unchanged, only the location
moved. A compatibility shim remains at the old path so existing imports
(`from .tiklive_provider import TikLiveAPIProvider`) keep working.
